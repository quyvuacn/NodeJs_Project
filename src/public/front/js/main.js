...
let el_select =  document.querySelectorAll('.p-show')?.[0]
let el_div = document.querySelectorAll('.p-show')?.[1]
if(el_select){
    $(el_div).find('.current').text('Show :')
    let span = document.createElement('span')
    span.className = 'p-show-span'
    span.textContent = el_select.value
    el_div.appendChild(span)
    $(el_select).change(function(e){
        $(el_div).find('.current').text('Show :')
